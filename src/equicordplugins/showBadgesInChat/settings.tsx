...
const settings = definePluginSettings({
    showEquicordDonor: {
        ...
        description: "Enable to show LawyerCord Donor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the LawyerCord Donor badges.",
        hidden: true,
        default: 0
    },
    showEquicordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show LawyerCord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the LawyerCord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
