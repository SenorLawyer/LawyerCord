...
function EquicordSettings() {
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how LawyerCord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(EquicordSettings, "LawyerCord Settings");
