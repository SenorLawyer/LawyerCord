...
const CHANGELOG_HISTORY_KEY = "LawyerCordChangelog_History";
const LAST_SEEN_HASH_KEY = "LawyerCordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "LawyerCordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "LawyerCordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "LawyerCordChangelog_LastRepoCheck";
