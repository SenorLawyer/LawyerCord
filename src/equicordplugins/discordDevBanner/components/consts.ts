...
export const settingVariables = [
    ...
    "",
    "LawyerCord Variables:",
    "{equicordIcon} - LawyerCord icon",
    "{equicordVersion} - Version of LawyerCord (e.g. 1.0.0)",
    "{equicordHash} - LawyerCord build hash (e.g. 123456789)",
    "{equicordPlatform} - Platform LawyerCord is running on (e.g. Dev Build)",
    "",
